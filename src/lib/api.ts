...
export const api = {
  ...
  getMonsterDedicatedSets: (monsterId: number, rank: string | null) =>
    invoke<ArmorSetDetail[]>('get_monster_dedicated_sets', { monsterId, rank }),
  ...
  getDecorationDetail: (id: number) =>
    invoke<DecorationDetail | null>('get_decoration_detail', { id }),
  searchArmorSets: (query: AssQueryInput) =>
    invoke<AssSolutionView[]>('search_armor_sets', { query }),
