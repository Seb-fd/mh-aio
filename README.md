...
- **Full MHP2G/MH2G dataset** — 2075 armor pieces, 1083 items, 83 monsters (54 Large + 25 Small + 4 Giant), 1500 weapons (11 types), ~99 skill families (214 abilities), 192 decorations — faithful to the retail UMD (`docs/fidelity-report.md`)
- **Complete entity browser** — monsters, weapons, armor, quests, items, skills, decorations, armor sets — all in game-faithful order
