...
- [x] Counts stable across double-seed (idempotent `INSERT OR IGNORE` + UNIQUE indexes; see known exception below): items 1083, `item_sources` 12751, combines 432, monsters 83 (54 Large + 25 Small + 4 Giant), weapons 1500 (11 types), armor 2075 / sets 949 derived, quests 610 (95 Village Elder + 35 Nekoto + 89 Guild Low + 77 Guild High + 116 Guild G + 140 Training + 7 Treasure + 37 Event + 14 Challenge), skills 99 / levels 214, decorations 192, drops 2319, weaknesses 163, equipment 1880, weapon_mats 5137 / craft 1075, quest_rewards 1269.
- [x] Item taxonomy ISO-derived: `Consumable 91 / Material 913 / Ammo 79` + `subcategory` (Recovery/Buff/Food/Charm/Husk/Coating/Ore/Monster Material…; `Powercharm/Powertalon` → `Consumable • Charm`, `Huskberry/Sm Bone Husk` → `Ammo • Husk`).
